...
methods: {
    ...
    // funzione per inserire il messaggio scritto nell'imput fra i messaggi inviati nella chat
    getMessage: function(message){
        ...
        // funzione per restituire la risposta al messaggio inviato nella chat
        setTimeout(() => {
            const autoReply = {
                date: new Date().toLocaleString('it-IT'),
                message: 'ok',
